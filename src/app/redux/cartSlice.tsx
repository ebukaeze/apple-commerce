...
export const cartSlice = createSlice({
    ...
    reducers: {
        ...
        removeCartItem: (state:CartState, action: PayloadAction<{id: string}>) => {
            ...
            if(index >= 0){
                ...
                console.log(`Can't remove this item with id:${action.payload.id} because it's not found in the Cart`);
