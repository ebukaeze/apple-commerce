    ...
    >
      ...
      >
        <BrowserView>
          {isBrowser && (
            <Image
              ...
              className="object-contain lg:flex hidden relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert"
              fill
            />
          )}
        </BrowserView>
        ...
        <Image
          src="/appleflat.png"
          alt="iphone 14 pro max"
          className="object-contain md:hidden flex relative dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert"
          fill
        />
      </div>
    </section>
