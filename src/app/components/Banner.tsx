    ...
    >
      ...
      <div
        className="lg:col-span-4 order-2 relative h-[450px] w-[100%] lg:w-[550px] sm:w-[100%] transition-all duration-100 
          ...
          place-items-center before:absolute before:h-[300px] lg:before:w-[400px] before:w-[50px] lg:before:-translate-x-1/3 before:translate-x-1/3 text-center before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] md:after:w-[400px] md:after:translate-x-1/4 after:w-[200px] after:translate-x-1/6 after:bg-gradient-conic after:from-pink-800 after:via-sky-300 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px] z-[-1]"
      >
        <Image
          src="/appleflat.png"
