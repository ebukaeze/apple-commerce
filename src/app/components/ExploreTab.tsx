    ...
    <div className="w-full flex flex-col mt-6 ">
     ...
     h-[80px] transition-all"
        >
         ...
         outline-none md:pt-4 md:px-6 md:text-base pb-0 transition ease-in-out duration-300
         ${
           selected
             ? "borderGradient bg-[#8b8b8b] text-black transition ease-in-out hover:translate-y-1 duration-300"
        ...
        <Tab.Panels
          className="w-[80%] mx-auto max-w-6xl pt-10 pb-24 sm:px-4 flex
      lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16"
        >
          <Tab.Panel className="tabPanel lg:grid md:grid-cols-2 sm:grid-cols-1 xl:grid-cols-2 gap-8">
            {showProducts(0)}
          </Tab.Panel>
          <Tab.Panel className="tabPanel lg:grid md:grid-cols-2 sm:grid-cols-1 xl:grid-cols-2 gap-8">
            {showProducts(1)}
